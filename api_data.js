      ...
      "fields": {
        "Payload": [
          ...
          },
          {
            ...
            "field": "public",
            "defaultValue": "false",
            "description": "<ul> <li>when <code>true</code> returns only publicly marked users</li> </ul>"
          },
          {
            "group": "Payload",
            "type": "Object",
            "optional": false,
            "field": "-",
            "description": "<p>filter to use, consult https://github.com/makeomatic/redis-filtered-sort, can already be stringified</p>"
          }
        ]
      }
    },
        ...
        "Payload": [
          {
            ...
            "optional": false,
            "field": "username",
            "description": "<ul> <li>user's username, can be <code>alias</code> or real <code>username</code>. If it's a real username - then all the data is returned.</li> </ul>"
          },
          {
            "group": "Payload",
            "type": "String[]",
